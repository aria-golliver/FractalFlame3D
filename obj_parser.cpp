...
int obj_parse_obj_file(obj_growable_scene_data *growable_data, string filename)
{
	...
	int line_number = 0;
	// open scene
	obj_file_stream = fopen( filename.c_str(), "r");
...
int parse_obj_scene(obj_scene_data *data_out, string filename)
{
